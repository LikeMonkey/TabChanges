...
@interface MenuScreeningView ()<DropMenuViewDelegate,DropTextViewDelegate>
...
@property (nonatomic, strong) DropTextView *oneLinkageDropMenu;
@property (nonatomic, strong) DropTextView *twoLinkageDropMenu;
@property (nonatomic, strong) DropTextView *threeLinkageDropMenu;
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.oneLinkageDropMenu = [[DropTextView alloc] init];
       ...
       self.oneLinkageDropMenu.delegate = self;
        ...
        self.twoLinkageDropMenu = [[DropTextView alloc] init];
       ...
       self.twoLinkageDropMenu.delegate = self;
        ...
        self.threeLinkageDropMenu = [[DropTextView alloc] init];
...
-(void)clickButton:(UIButton *)button{
    ...
    if (button == self.oneLinkageButton) {
        ...
        [self.oneLinkageDropMenu creatDropTextView:self withShowTableNum:1 withData:self.sortsArr];
        ...
        [self.twoLinkageDropMenu creatDropTextView:self withShowTableNum:2 withData:self.categoriesArr];
        ...
        [self.threeLinkageDropMenu creatDropTextView:self withShowTableNum:3 withData:self.addressArr];
    }
}
